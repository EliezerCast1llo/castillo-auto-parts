...
type MobileMenuProps = {
  ...
  accountHref: string;
  accountLabel: string;
  /** Variante visual: "dark" para header de home (navy), "light" para site-header */
  variant?: "dark" | "light";
};
...
export function MobileMenu({
  ...
  return (
    <>
      ...
      {/* Drawer lateral */}
      <div
        className={`fixed inset-y-0 right-0 z-[100] flex w-72 max-w-[85vw] flex-col bg-white shadow-[var(--ca-shadow-hero)] transition-transform duration-300 ${
