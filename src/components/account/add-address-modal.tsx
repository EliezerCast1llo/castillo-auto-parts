...
export function AddAddressModal({ deliveryZones }: { deliveryZones: DeliveryZoneOption[] }) {
 ...
 <div className="fixed inset-x-4 top-1/2 z-[100] w-full max-w-lg -translate-y-1/2 rounded-ca-surface border border-ca-border bg-white shadow-ca-overlay sm:inset-x-auto sm:left-1/2 sm:-translate-x-1/2">
 {/* Header */}
